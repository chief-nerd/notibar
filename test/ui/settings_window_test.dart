...
void main() {
  testWidgets('SettingsWindow renders tabs and loaded state', (WidgetTester tester) async {
    final mockBloc = MockNotibarBloc();
    
    when(() => mockBloc.state).thenReturn(const NotibarLoaded(
      accounts: [],
      options: [],
    ...
    expect(find.text('Add an account first in the Accounts tab'), findsOneWidget);
